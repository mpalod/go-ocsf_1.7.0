...
type SSHActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>SSH Activity</code>.
...
func (v *SSHActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *SSHActivity) ValidateObservables() error {
