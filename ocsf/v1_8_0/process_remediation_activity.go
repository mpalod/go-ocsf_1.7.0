...
type ProcessRemediationActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Process Remediation Activity</code>.
...
func (v *ProcessRemediationActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *ProcessRemediationActivity) ValidateObservables() error {
