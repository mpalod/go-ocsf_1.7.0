...
type RemediationActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Remediation Activity</code>.
...
func (v *RemediationActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *RemediationActivity) ValidateObservables() error {
