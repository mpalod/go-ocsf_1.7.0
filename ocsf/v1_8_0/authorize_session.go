...
type AuthorizeSession struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Authorize Session</code>.
	...
	// User: The user to which new privileges were assigned.
	User User `json:"user" parquet:"user"`
}

func (v *AuthorizeSession) Observable() (*int, string) {
	return nil, ""
}

func (v *AuthorizeSession) ValidateObservables() error {
