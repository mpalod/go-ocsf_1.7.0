...
type KernelExtensionActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Kernel Extension Activity</code>.
...
func (v *KernelExtensionActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *KernelExtensionActivity) ValidateObservables() error {
