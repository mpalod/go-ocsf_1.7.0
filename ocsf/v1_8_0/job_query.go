...
type JobQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Job Query</code>.
...
func (v *JobQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *JobQuery) ValidateObservables() error {
