...
type DeviceInventoryInfo struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Device Inventory Info</code>.
...
func (v *DeviceInventoryInfo) Observable() (*int, string) {
	return nil, ""
}

func (v *DeviceInventoryInfo) ValidateObservables() error {
