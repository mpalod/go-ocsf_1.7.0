...
type TunnelActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Tunnel Activity</code>.
	...
	// Source Endpoint: The initiator (client) of the tunnel connection.
	...
	// Traffic: Traffic refers to the amount of data moving across the tunnel at a given point of time. Ex: <code>bytes_in</code> and <code>bytes_out</code>.
	Traffic *NetworkTraffic `json:"traffic,omitempty" parquet:"traffic,optional"`

	// Tunnel Interface: The information about the virtual tunnel interface, e.g. <code>utun0</code>. This is usually associated with the private (rfc-1918) ip of the tunnel.
	TunnelInterface *NetworkInterface `json:"tunnel_interface,omitempty" parquet:"tunnel_interface,optional"`

	// Type: The tunnel type. Example: <code>Split</code> or <code>Full</code>.
	TunnelType *string `json:"tunnel_type,omitempty" parquet:"tunnel_type,optional"`

	// Type: The normalized tunnel type ID.
	...
	// User: The user associated with the tunnel activity.
...
var TunnelActivityFields = []arrow.Field{
	...
	{Name: "tunnel_interface", Type: NetworkInterfaceStruct, Nullable: true},
	{Name: "tunnel_type", Type: arrow.BinaryTypes.String, Nullable: true},
	{Name: "tunnel_type_id", Type: arrow.PrimitiveTypes.Int32, Nullable: true},
