...
type EmailFileActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Email File Activity</code>.
...
func (v *EmailFileActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *EmailFileActivity) ValidateObservables() error {
