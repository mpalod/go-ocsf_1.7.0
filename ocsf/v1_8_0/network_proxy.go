...
type NetworkProxyEndpoint struct {
	...
	// Fingerprints: Fingerprints that identify the specific application implementation on this endpoint, such as Cisco NPF or HASSH.
	...
	// MAC Vendor: The vendor or manufacturer of the endpoint's network interface controller (NIC), as identified from the MAC address.
	MacVendor *string `json:"mac_vendor,omitempty" parquet:"mac_vendor,optional"`
	...
	// Pool: The pool of desktops or virtual machines to which the endpoint belongs.
	Pool *Group `json:"pool,omitempty" parquet:"pool,optional"`
	...
	ProxyEndpoint *NetworkProxyEndpointRef `json:"proxy_endpoint,omitempty" parquet:"proxy_endpoint,optional"`
...
var NetworkProxyEndpointFields = []arrow.Field{
	...
	{Name: "mac_vendor", Type: arrow.BinaryTypes.String, Nullable: true},
	...
	{Name: "pool", Type: GroupStruct, Nullable: true},
	{Name: "port", Type: arrow.PrimitiveTypes.Int32, Nullable: true},
	{Name: "proxy_endpoint", Type: NetworkProxyEndpointRefStruct, Nullable: true},
...
var NetworkProxyEndpointRefStruct = arrow.StructOf(NetworkProxyEndpointRefFields...)

type NetworkProxyEndpointRef struct {
