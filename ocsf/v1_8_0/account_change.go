...
type AccountChange struct {
	...
	// Authentication Factors: Details about the authentication factors associated with the MFA Factor Enable/Disable activities.
	...
	// Class: The event class name, as defined by class_uid value: <code>Account Change</code>.
	...
	// User: The user that was a target of an activity.
	...
	UserResult *User `json:"user_result,omitempty" parquet:"user_result,optional"`
}

func (v *AccountChange) Observable() (*int, string) {
	return nil, ""
}

func (v *AccountChange) ValidateObservables() error {
...
var AccountChangeFields = []arrow.Field{
	...
	{Name: "user_result", Type: UserStruct, Nullable: true},
}
