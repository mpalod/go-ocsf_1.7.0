...
type KernelObjectQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Kernel Object Query</code>.
...
func (v *KernelObjectQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *KernelObjectQuery) ValidateObservables() error {
