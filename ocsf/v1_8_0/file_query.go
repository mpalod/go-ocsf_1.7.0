...
type FileQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>File Query</code>.
...
func (v *FileQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *FileQuery) ValidateObservables() error {
