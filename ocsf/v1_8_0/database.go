...
type Database struct {
	...
	// Embedding Model: Model used for creating embeddings (if applicable). For example: <code>text-embedding-ada-002</code> or <code>all-MiniLM-L6-v2</code>.
	EmbeddingModel *string `json:"embedding_model,omitempty" parquet:"embedding_model,optional"`
