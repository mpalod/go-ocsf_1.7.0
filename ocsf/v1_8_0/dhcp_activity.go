...
type DHCPActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>DHCP Activity</code>.
	...
	// Source Endpoint: The initiator (client) of the DHCP connection.
	...
	// Transaction UID: The unique identifier of the transaction. This is typically a random number generated from the client to associate a dhcp request/response pair.
...
func (v *DHCPActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *DHCPActivity) ValidateObservables() error {
...
var DHCPActivityFields = []arrow.Field{
	...
	{Name: "transaction_uid", Type: arrow.BinaryTypes.String, Nullable: true},
