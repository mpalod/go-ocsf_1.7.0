...
type WindowsResourceActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Windows Resource Activity</code>.
...
func (v *WindowsResourceActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *WindowsResourceActivity) ValidateObservables() error {
...
var WindowsResourceActivityFields = []arrow.Field{
	...
	{Name: "win_resource", Type: WindowsResourceStruct, Nullable: false},
}
