...
type ScriptActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Script Activity</code>.
...
func (v *ScriptActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *ScriptActivity) ValidateObservables() error {
