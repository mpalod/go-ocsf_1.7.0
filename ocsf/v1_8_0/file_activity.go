...
type FileSystemActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>File System Activity</code>.
...
func (v *FileSystemActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *FileSystemActivity) ValidateObservables() error {
