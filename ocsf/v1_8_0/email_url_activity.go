...
type EmailURLActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Email URL Activity</code>.
	...
	// URL: The URL included in the email content.
	Url UniformResourceLocator `json:"url" parquet:"url"`
}

func (v *EmailURLActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *EmailURLActivity) ValidateObservables() error {
...
var EmailURLActivityFields = []arrow.Field{
	...
	{Name: "url", Type: UniformResourceLocatorStruct, Nullable: false},
}
