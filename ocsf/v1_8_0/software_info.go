...
type SoftwareInventoryInfo struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Software Inventory Info</code>.
...
func (v *SoftwareInventoryInfo) Observable() (*int, string) {
	return nil, ""
}

func (v *SoftwareInventoryInfo) ValidateObservables() error {
