...
type WebResourcesActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Web Resources Activity</code>.
	...
	// Source Endpoint: Details about the endpoint from which the request originated.
	...
	// TLS: The Transport Layer Security (TLS) attributes, if available.
	...
	// Web Resources: Describes details about web resources that were affected by an activity/event.
	WebResources []WebResource `json:"web_resources" parquet:"web_resources,list"`

	// Web Resources Result: The results of the activity on web resources. It should contain the new values of the changed attributes of the web resources.
	WebResourcesResult []WebResource `json:"web_resources_result,omitempty" parquet:"web_resources_result,list,optional"`
}

func (v *WebResourcesActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *WebResourcesActivity) ValidateObservables() error {
...
var WebResourcesActivityFields = []arrow.Field{
	...
	{Name: "web_resources", Type: arrow.ListOf(WebResourceStruct), Nullable: false},
	{Name: "web_resources_result", Type: arrow.ListOf(WebResourceStruct), Nullable: true},
}
