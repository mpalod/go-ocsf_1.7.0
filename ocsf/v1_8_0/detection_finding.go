...
type DetectionFinding struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Detection Finding</code>.
...
func (v *DetectionFinding) Observable() (*int, string) {
	return nil, ""
}

func (v *DetectionFinding) ValidateObservables() error {
