...
type UserQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>User Query</code>.
...
func (v *UserQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *UserQuery) ValidateObservables() error {
