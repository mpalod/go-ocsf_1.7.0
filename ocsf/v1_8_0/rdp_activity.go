...
type RDPActivity struct {
	...
	// Connection Info: The remote desktop connection details, either connection-based or connectionless.
	...
	// API Request Details: The client request in an RDP network connection.
	...
	// User: The target user associated with the RDP activity.
	User *User `json:"user,omitempty" parquet:"user,optional"`
}

func (v *RDPActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *RDPActivity) ValidateObservables() error {
