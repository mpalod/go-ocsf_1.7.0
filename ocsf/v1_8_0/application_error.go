...
type ApplicationError struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Application Error</code>.
...
func (v *ApplicationError) Observable() (*int, string) {
	return nil, ""
}

func (v *ApplicationError) ValidateObservables() error {
