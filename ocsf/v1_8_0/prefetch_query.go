...
type PrefetchQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Prefetch Query</code>.
	...
	// Name: The name of the prefetch file that is the target of the query.
...
func (v *PrefetchQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *PrefetchQuery) ValidateObservables() error {
