...
type OSINTInventoryInfo struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>OSINT Inventory Info</code>.
...
func (v *OSINTInventoryInfo) Observable() (*int, string) {
	return nil, ""
}

func (v *OSINTInventoryInfo) ValidateObservables() error {
