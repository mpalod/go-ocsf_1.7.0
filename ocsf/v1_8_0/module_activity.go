...
type ModuleActivity struct {
	...
	// Actor: The actor that performed the activity on the target <code>module</code>. For example, the process that loaded a module into memory.
	...
	// Class: The event class name, as defined by class_uid value: <code>Module Activity</code>.
	...
	// Module: The module that was loaded, unloaded, or invoked.
...
func (v *ModuleActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *ModuleActivity) ValidateObservables() error {
