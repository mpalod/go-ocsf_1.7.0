...
type IAMAnalysisFinding struct {
	...
	// Applications: Details about applications, services, or systems that are accessible based on the IAM analysis. For identity-centric analysis, this represents applications the identity can access. For resource-centric analysis, this represents applications that can access the resource.
	Applications []Application `json:"applications,omitempty" parquet:"applications,list,optional"`
	...
	// Class: The event class name, as defined by class_uid value: <code>IAM Analysis Finding</code>.
	...
	// Device: Describes the affected device/host. If applicable, it can be used in conjunction with <code>Resource(s)</code>. <p> e.g. Specific details about an AWS EC2 instance, that is affected by the Finding.</p>
	...
	// Identity Activity Metrics: Describes usage activity and other metrics of an Identity i.e. AWS IAM User, GCP IAM Principal, etc.
	IdentityActivityMetrics *IdentityActivityMetrics `json:"identity_activity_metrics,omitempty" parquet:"identity_activity_metrics,optional"`
	...
	// Resources Array: Details about resources involved in the IAM analysis. For identity-centric analysis, this represents resources the identity can access. For resource-centric analysis, this represents the resource being analyzed and related resources in the access chain.
	...
	// User: Details about the identity (user, role, service account, or other principal) that is the subject of the IAM analysis. This provides context about the identity being evaluated for security risks and access patterns.
...
func (v *IAMAnalysisFinding) Observable() (*int, string) {
	return nil, ""
}

func (v *IAMAnalysisFinding) ValidateObservables() error {
...
var IAMAnalysisFindingFields = []arrow.Field{
	{Name: "access_analysis_result", Type: AccessAnalysisResultStruct, Nullable: true},
	...
	{Name: "applications", Type: arrow.ListOf(ApplicationStruct), Nullable: true},
	...
	{Name: "identity_activity_metrics", Type: IdentityActivityMetricsStruct, Nullable: true},
	...
	{Name: "permission_analysis_results", Type: arrow.ListOf(PermissionAnalysisResultStruct), Nullable: true},
...
var IAMAnalysisFindingStruct = arrow.StructOf(IAMAnalysisFindingFields...)

var IAMAnalysisFindingSchema = arrow.NewSchema(IAMAnalysisFindingFields, nil)
var IAMAnalysisFindingClassname = "iam_analysis_finding"
