...
type NetworksQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Networks Query</code>.
...
func (v *NetworksQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *NetworksQuery) ValidateObservables() error {
