...
type UserInventoryInfo struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>User Inventory Info</code>.
	...
	// User: The user that is being discovered by an inventory process.
	User User `json:"user" parquet:"user"`
}

func (v *UserInventoryInfo) Observable() (*int, string) {
	return nil, ""
}

func (v *UserInventoryInfo) ValidateObservables() error {
