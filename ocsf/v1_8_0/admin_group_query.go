...
type AdminGroupQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Admin Group Query</code>.
	...
	// Users: The users that belong to the administrative group.
	Users []User `json:"users,omitempty" parquet:"users,list,optional"`
}

func (v *AdminGroupQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *AdminGroupQuery) ValidateObservables() error {
