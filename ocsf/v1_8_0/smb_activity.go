...
type SMBActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>SMB Activity</code>.
	...
	// Share Type: The SMB share type, normalized to the caption of the share_type_id value. In the case of 'Other', it is defined by the event source.
	ShareType *string `json:"share_type,omitempty" parquet:"share_type,optional"`

	// Share Type ID: The normalized identifier of the SMB share type.
...
func (v *SMBActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *SMBActivity) ValidateObservables() error {
...
var SMBActivityFields = []arrow.Field{
	...
	{Name: "share_type", Type: arrow.BinaryTypes.String, Nullable: true},
	{Name: "share_type_id", Type: arrow.PrimitiveTypes.Int32, Nullable: true},
	...
	{Name: "tree_uid", Type: arrow.BinaryTypes.String, Nullable: true},
