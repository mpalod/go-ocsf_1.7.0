...
type WebResourceAccessActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Web Resource Access Activity</code>.
	...
	// Source Endpoint: Details about the source endpoint of the request.
	...
	// Web Resources: Details about the resource that is the target of the activity.
	WebResources []WebResource `json:"web_resources" parquet:"web_resources,list"`
}

func (v *WebResourceAccessActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *WebResourceAccessActivity) ValidateObservables() error {
...
var WebResourceAccessActivityStruct = arrow.StructOf(WebResourceAccessActivityFields...)

var WebResourceAccessActivitySchema = arrow.NewSchema(WebResourceAccessActivityFields, nil)
var WebResourceAccessActivityClassname = "web_resource_access_activity"
