...
type BaseEvent struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Base Event</code>.
...
func (v *BaseEvent) Observable() (*int, string) {
	return nil, ""
}

func (v *BaseEvent) ValidateObservables() error {
