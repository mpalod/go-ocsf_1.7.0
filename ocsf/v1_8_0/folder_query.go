...
type FolderQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Folder Query</code>.
...
func (v *FolderQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *FolderQuery) ValidateObservables() error {
