...
type DNSActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>DNS Activity</code>.
	...
	// Response Code: The DNS server response code, normalized to the caption of the rcode_id value. In the case of 'Other', it is defined by the event source.
	Rcode *string `json:"rcode,omitempty" parquet:"rcode,optional"`
