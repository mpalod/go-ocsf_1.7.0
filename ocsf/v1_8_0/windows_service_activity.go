...
type WindowsServiceActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Windows Service Activity</code>.
	...
	// Windows Service: The Windows service.
	WinService WindowsService `json:"win_service" parquet:"win_service"`
}

func (v *WindowsServiceActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *WindowsServiceActivity) ValidateObservables() error {
...
var WindowsServiceActivityFields = []arrow.Field{
	...
	{Name: "win_service", Type: WindowsServiceStruct, Nullable: false},
}
