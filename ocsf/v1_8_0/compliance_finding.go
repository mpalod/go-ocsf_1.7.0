...
type ComplianceFinding struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Compliance Finding</code>.
	...
	// Evidence Artifacts: Describes various evidence artifacts associated with the compliance finding.
	...
	// Resources Array: Describes details about the resource/resources that are the subject of the compliance check.
