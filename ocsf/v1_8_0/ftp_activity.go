...
type FTPActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>FTP Activity</code>.
	...
	// Name: The name of the data affiliated with the command.
	...
	// Type: The type of FTP network connection (e.g. active, passive).
...
func (v *FTPActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *FTPActivity) ValidateObservables() error {
