...
type DatastoreActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Datastore Activity</code>.
	...
	// Datastore Type: The datastore resource type (e.g. database, datastore, or table).
	Type *string `json:"type,omitempty" parquet:"type,optional"`

	// Datastore Type ID: The normalized datastore resource type identifier.
...
func (v *DatastoreActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *DatastoreActivity) ValidateObservables() error {
