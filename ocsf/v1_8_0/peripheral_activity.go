...
type PeripheralActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Peripheral Activity</code>.
	...
	// Peripheral Device: The peripheral device that is the subject of the activity.
...
func (v *PeripheralActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *PeripheralActivity) ValidateObservables() error {
...
var PeripheralActivityFields = []arrow.Field{
...
var PeripheralActivityStruct = arrow.StructOf(PeripheralActivityFields...)

var PeripheralActivitySchema = arrow.NewSchema(PeripheralActivityFields, nil)
var PeripheralActivityClassname = "peripheral_activity"
