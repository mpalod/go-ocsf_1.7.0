...
type ProcessQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Process Query</code>.
...
func (v *ProcessQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *ProcessQuery) ValidateObservables() error {
