...
type UserSessionQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>User Session Query</code>.
...
func (v *UserSessionQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *UserSessionQuery) ValidateObservables() error {
