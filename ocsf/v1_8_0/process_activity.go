...
type ProcessActivity struct {
	...
	// Actor: The actor that performed the activity on the target <code>process</code>. For example, the process that started a new process or injected code into another process.
	...
	// AI Model: The AI Model object describes the characteristics of an AI/ML model. Examples include language models like GPT-4, embedding models like text-embedding-ada-002, and computer vision models like CLIP.
	AiModel *AIModel `json:"ai_model,omitempty" parquet:"ai_model,optional"`
	...
	// Class: The event class name, as defined by class_uid value: <code>Process Activity</code>.
	...
	// Launch Type: The specific type of <code>Launch</code> activity, normalized to the caption of the <code>launch_type_id</code> value. In the case of <code>Other</code> it is defined by the event source.
	LaunchType *string `json:"launch_type,omitempty" parquet:"launch_type,optional"`

	// Launch Type ID: The normalized identifier for the specific type of <code>Launch</code> activity.
	LaunchTypeId *int32 `json:"launch_type_id,omitempty" parquet:"launch_type_id,optional"`
	...
	// Message Context: Communication context for AI system interactions including protocols, roles, clients, and session information for MCP and other AI communication systems.
	MessageContext *MessageContext `json:"message_context,omitempty" parquet:"message_context,optional"`

	// Metadata: The metadata associated with the event or a finding.
	Metadata Metadata `json:"metadata" parquet:"metadata"`

	// Module: The module that was injected by the actor process.
...
func (v *ProcessActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *ProcessActivity) ValidateObservables() error {
...
var ProcessActivityFields = []arrow.Field{
	...
	{Name: "ai_model", Type: AIModelStruct, Nullable: true},
	...
	{Name: "launch_type", Type: arrow.BinaryTypes.String, Nullable: true},
	{Name: "launch_type_id", Type: arrow.PrimitiveTypes.Int32, Nullable: true},
	...
	{Name: "message_context", Type: MessageContextStruct, Nullable: true},
