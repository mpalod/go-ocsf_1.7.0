...
type ScheduledJobActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Scheduled Job Activity</code>.
...
func (v *ScheduledJobActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *ScheduledJobActivity) ValidateObservables() error {
