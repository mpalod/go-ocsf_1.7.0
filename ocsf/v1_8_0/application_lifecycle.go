...
type ApplicationLifecycle struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Application Lifecycle</code>.
...
func (v *ApplicationLifecycle) Observable() (*int, string) {
	return nil, ""
}

func (v *ApplicationLifecycle) ValidateObservables() error {
