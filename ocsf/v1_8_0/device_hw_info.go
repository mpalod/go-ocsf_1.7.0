...
type DeviceHardwareInfo struct {
	...
	// GPU Count: The number of GPU's on a system. For example: <code>1</code>.
	GpuCount *int32 `json:"gpu_count,omitempty" parquet:"gpu_count,optional"`

	// GPU information: A list of GPU objects describing the hardware properties of each graphics processor installed on the device.
	GpuInfoList []GPUInformation `json:"gpu_info_list,omitempty" parquet:"gpu_info_list,list,optional"`
...
var DeviceHardwareInfoFields = []arrow.Field{
	...
	{Name: "gpu_count", Type: arrow.PrimitiveTypes.Int32, Nullable: true},
	{Name: "gpu_info_list", Type: arrow.ListOf(GPUInformationStruct), Nullable: true},
