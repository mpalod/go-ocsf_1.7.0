...
type FileHostingActivity struct {
	...
	// Access Mask: The sum of hexadecimal values of requested access rights.
	...
	// Class: The event class name, as defined by class_uid value: <code>File Hosting Activity</code>.
	...
	// Share Type: The share type, normalized to the caption of the share_type_id value. In the case of 'Other', it is defined by the event source.
	ShareType *string `json:"share_type,omitempty" parquet:"share_type,optional"`

	// Share Type ID: The normalized identifier of the share type.
...
func (v *FileHostingActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *FileHostingActivity) ValidateObservables() error {
...
var FileHostingActivityFields = []arrow.Field{
