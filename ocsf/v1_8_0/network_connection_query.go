...
type NetworkConnectionQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Network Connection Query</code>.
	...
	// Query Result ID: The normalized identifier of the query result.
	...
	// State: The state of the socket, normalized to the caption of the state_id value. In the case of 'Other', it is defined by the event source.
	State *string `json:"state,omitempty" parquet:"state,optional"`

	// State ID: The state of the socket.
...
func (v *NetworkConnectionQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *NetworkConnectionQuery) ValidateObservables() error {
