...
type OperatingSystemPatchState struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Operating System Patch State</code>.
...
func (v *OperatingSystemPatchState) Observable() (*int, string) {
	return nil, ""
}

func (v *OperatingSystemPatchState) ValidateObservables() error {
