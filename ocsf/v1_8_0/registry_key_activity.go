...
type RegistryKeyActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Registry Key Activity</code>.
...
func (v *RegistryKeyActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *RegistryKeyActivity) ValidateObservables() error {
