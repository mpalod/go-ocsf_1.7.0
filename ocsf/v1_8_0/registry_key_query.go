...
type RegistryKeyQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Registry Key Query</code>.
...
func (v *RegistryKeyQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *RegistryKeyQuery) ValidateObservables() error {
