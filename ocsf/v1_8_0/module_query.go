...
type ModuleQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Module Query</code>.
...
func (v *ModuleQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *ModuleQuery) ValidateObservables() error {
