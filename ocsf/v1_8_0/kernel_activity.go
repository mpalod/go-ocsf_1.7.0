...
type KernelActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Kernel Activity</code>.
...
func (v *KernelActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *KernelActivity) ValidateObservables() error {
