...
type NetworkFileActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Network File Activity</code>.
	...
	// Source Endpoint: The endpoint that performed the activity on the target file.
...
func (v *NetworkFileActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *NetworkFileActivity) ValidateObservables() error {
