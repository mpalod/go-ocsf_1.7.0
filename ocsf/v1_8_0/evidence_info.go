...
type LiveEvidenceInfo struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Live Evidence Info</code>.
...
func (v *LiveEvidenceInfo) Observable() (*int, string) {
	return nil, ""
}

func (v *LiveEvidenceInfo) ValidateObservables() error {
...
var LiveEvidenceInfoStruct = arrow.StructOf(LiveEvidenceInfoFields...)

var LiveEvidenceInfoSchema = arrow.NewSchema(LiveEvidenceInfoFields, nil)
var LiveEvidenceInfoClassname = "evidence_info"
