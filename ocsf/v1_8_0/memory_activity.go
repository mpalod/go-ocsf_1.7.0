...
type MemoryActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Memory Activity</code>.
	...
	// Size: The memory size that was access or requested.
...
func (v *MemoryActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *MemoryActivity) ValidateObservables() error {
