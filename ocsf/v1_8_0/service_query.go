...
type ServiceQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Service Query</code>.
...
func (v *ServiceQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *ServiceQuery) ValidateObservables() error {
