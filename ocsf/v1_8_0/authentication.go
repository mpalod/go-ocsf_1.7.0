...
type Authentication struct {
	...
	// Account Switch Type: The account switch method, normalized to the caption of the account_switch_type_id value. In the case of 'Other', it is defined by the event source.
	AccountSwitchType *string `json:"account_switch_type,omitempty" parquet:"account_switch_type,optional"`

	// Account Switch Type ID: The normalized identifier of the account switch method.
	AccountSwitchTypeId *int32 `json:"account_switch_type_id,omitempty" parquet:"account_switch_type_id,optional"`
...
var AuthenticationFields = []arrow.Field{
	{Name: "account_switch_type", Type: arrow.BinaryTypes.String, Nullable: true},
	{Name: "account_switch_type_id", Type: arrow.PrimitiveTypes.Int32, Nullable: true},
