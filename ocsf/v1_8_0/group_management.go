...
type GroupManagement struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Group Management</code>.
	...
	Subgroup *Group `json:"subgroup,omitempty" parquet:"subgroup,optional"`
	...
	// User: A user that was added to or removed from the group.
	User *User `json:"user,omitempty" parquet:"user,optional"`
}

func (v *GroupManagement) Observable() (*int, string) {
	return nil, ""
}

func (v *GroupManagement) ValidateObservables() error {
...
var GroupManagementFields = []arrow.Field{
	...
	{Name: "subgroup", Type: GroupStruct, Nullable: true},
