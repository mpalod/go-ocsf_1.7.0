...
type IncidentFinding struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Incident Finding</code>.
	...
	// End Time: The time of the most recent event included in the incident.
	...
	// Status: The normalized status of the Incident normalized to the caption of the status_id value. In the case of 'Other', it is defined by the source.
...
func (v *IncidentFinding) ValidateObservables() error {
