...
type DeviceConfigState struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Device Config State</code>.
...
func (v *DeviceConfigState) Observable() (*int, string) {
	return nil, ""
}

func (v *DeviceConfigState) ValidateObservables() error {
...
var DeviceConfigStateStruct = arrow.StructOf(DeviceConfigStateFields...)

var DeviceConfigStateSchema = arrow.NewSchema(DeviceConfigStateFields, nil)
var DeviceConfigStateClassname = "config_state"
