...
type RegistryValueActivity struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Registry Value Activity</code>.
...
func (v *RegistryValueActivity) Observable() (*int, string) {
	return nil, ""
}

func (v *RegistryValueActivity) ValidateObservables() error {
