...
type PeripheralDeviceQuery struct {
	...
	// Class: The event class name, as defined by class_uid value: <code>Peripheral Device Query</code>.
...
func (v *PeripheralDeviceQuery) Observable() (*int, string) {
	return nil, ""
}

func (v *PeripheralDeviceQuery) ValidateObservables() error {
