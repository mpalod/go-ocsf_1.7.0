...
type File struct {
	...
	// Imported Symbols: A list of symbols imported by the executable file.
	ImportedSymbols []string `json:"imported_symbols,omitempty" parquet:"imported_symbols,list,optional"`
	...
	// Digital Signatures: A collection of <code>Digital Signature</code> objects.
...
var FileFields = []arrow.Field{
	...
	{Name: "imported_symbols", Type: arrow.ListOf(arrow.BinaryTypes.String), Nullable: true},
